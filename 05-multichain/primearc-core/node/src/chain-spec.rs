...
/// Primearc Core mainnet config (using runtime preset with 22 validators)
pub fn flarechain_config() -> Result<ChainSpec, String> {
    ...
    .with_genesis_config_preset_name("primearc_core_mainnet")
    .build())
}
...
pub fn directors_9_config() -> Result<ChainSpec, String> {
    ...
    .with_genesis_config_preset_name("primearc_core_mainnet_restart_final")
    .build())
}
...
pub fn session_fixed_mainnet_config() -> Result<ChainSpec, String> {
    ...
    .with_genesis_config_preset_name("primearc_core_mainnet_session_fixed")
    .build())
}

/// ASF mainnet config (22 validators with Pure ASF finality)
pub fn asf_mainnet_config() -> Result<ChainSpec, String> {
    ...
    .with_genesis_config_preset_name("primearc_core_mainnet_asf")
    .build())
}
