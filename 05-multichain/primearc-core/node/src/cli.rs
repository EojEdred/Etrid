...
impl SubstrateCli for Cli {
    ...
    fn load_spec(&self, id: &str) -> Result<Box<dyn sc_service::ChainSpec>, String> {
        Ok(match id {
            ...
            "directors9" | "9directors" | "flarechain_9directors" | "primearc_9directors" => Box::new(crate::chain_spec::directors_9_config()?),
            "session_fixed" | "session-fixed" | "flarechain_session_fixed" | "primearc_session_fixed" => Box::new(crate::chain_spec::session_fixed_mainnet_config()?),
            "hybrid" | "mainnet_hybrid" | "flarechain_hybrid" | "primearc_hybrid" => Box::new(crate::chain_spec::hybrid_mainnet_config()?),
            "" | "flarechain" | "mainnet" | "flarechain_mainnet" | "primearc" | "primearc_mainnet" => Box::new(crate::chain_spec::flarechain_config()?),
