    ...
    impl sp_genesis_builder::GenesisBuilder<Block> for Runtime {
        ...
        fn get_preset(id: &Option<sp_genesis_builder::PresetId>) -> Option<Vec<u8>> {
            frame_support::genesis_builder_helper::get_preset::<RuntimeGenesisConfig>(id, |name| {
                match name.as_ref() {
                    ...
                    "test_minimal" => {
                        Some(include_bytes!("../presets/test_minimal.json").to_vec())
                    },
                    // Primearc Core mainnet presets
                    "primearc_core_mainnet" => {
                        Some(include_bytes!("../presets/primearc_core_mainnet.json").to_vec())
                    },
                    "primearc_core_mainnet_asf" => {
                        Some(include_bytes!("../presets/primearc_core_mainnet_asf.json").to_vec())
                    },
                    "primearc_core_mainnet_restart_final" => {
                        Some(include_bytes!("../presets/primearc_core_mainnet_restart_final.json").to_vec())
                    },
        ...
        fn preset_names() -> Vec<sp_genesis_builder::PresetId> {
            vec![
                ...
                "test_21val".into(),
                "test_minimal".into(),
                "primearc_core_mainnet".into(),
                "primearc_core_mainnet_asf".into(),
                "primearc_core_mainnet_restart_final".into(),
