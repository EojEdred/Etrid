#!/bin/bash
# Script to generate new Ëtrid Primearc Core mainnet chainspec with all 21 validators

set -e

BINARY="./target/release/etrid-validator"
PRESET_NAME="primearc_core_mainnet"
...
echo "=============================================="
echo "Generating Ëtrid Primearc Core Mainnet Chainspec"
echo "=============================================="
echo ""
