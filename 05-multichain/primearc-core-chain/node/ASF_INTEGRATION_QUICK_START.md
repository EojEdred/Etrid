...
# Tail node logs
tail -f ~/.local/share/primearc-core-chain/chains/dev/network/primearc-core-chain.log | grep asf
```
...
./primearc-core-chain-node --dev --enable-asf

# Check logs for RPC registration
tail -f ~/.local/share/primearc-core-chain/chains/dev/network/primearc-core-chain.log | grep "Enabling ASF RPC"
```
...
./primearc-core-chain-node --dev --telemetry-url 'wss://telemetry.polkadot.io/submit 0'
...
- **Primearc Core Chain Node:** `/Users/macbook/Desktop/etrid/05-multichain/primearc-core-chain/node/`
