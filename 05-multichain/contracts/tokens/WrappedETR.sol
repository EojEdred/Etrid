...
/**
 * @title WrappedETR
 * @notice Wrapped version of the native ETR token from Primearc Core Chain
...
contract WrappedETR is ERC20, ERC20Burnable, AccessControl, Pausable {
    ...
    /// @notice Emitted when tokens are bridged in from Primearc Core Chain
    event TokensBridgedIn(address indexed to, uint256 amount, bytes32 indexed txHash);

    /// @notice Emitted when tokens are bridged out to Primearc Core Chain
    ...
    /**
     * @notice Mint tokens when bridging from Primearc Core Chain
     * @param to Recipient address
     * @param amount Amount to mint
     * @param txHash Transaction hash from Primearc Core Chain
     */
    function bridgeMint(
        address to,
        uint256 amount,
    ...
    /**
     * @notice Burn tokens when bridging to Primearc Core Chain
     * @param from Address to burn from
     * @param amount Amount to burn
     * @param destinationAccount Primearc Core Chain destination account
     */
    function bridgeBurn(
        address from,
        uint256 amount,
