...
//!
//! This service:
//! 1. Produces blocks for the SOL-PBC
...
// SOL-PBC Runtime
use sol_pbc_runtime::{self, opaque::Block, RuntimeApi};
...
impl sc_executor::NativeExecutionDispatch for ExecutorDispatch {
    ...
    fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
        sol_pbc_runtime::api::dispatch(method, data)
    }

    fn native_version() -> sc_executor::NativeVersion {
        sol_pbc_runtime::native_version()
    }
}
...
> {
    ...
    panic!("new_partial not implemented - update for specific SOL-PBC runtime")
}
