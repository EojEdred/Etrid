...
use sol_pbc_runtime::{AccountId, WASM_BINARY};
...
pub fn local_testnet_config() -> Result<ChainSpec, String> {
    ...
    .with_name("SOL-PBC Local Testnet")
    .with_id("sol_pbc_local")
    .with_chain_type(ChainType::Local)
    .with_protocol_id("sol-pbc")
...
pub fn production_config() -> Result<ChainSpec, String> {
    ...
    .with_name("SOL-PBC Mainnet")
    .with_id("sol_pbc_mainnet")
