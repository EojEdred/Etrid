//! EDSC PBC Collator Node
//!
//! This collator produces blocks for the EDSC (Ëtrid Dollar Stablecoin) PBC
//! and submits state roots to FlareChain for multichain state aggregation.
//!
//! EDSC-PBC manages the algorithmic stablecoin operations including:
