...
//!
//! This service:
//! 1. Produces blocks for the ETH-PBC
...
// ETH-PBC Runtime
use eth_pbc_runtime::{self, opaque::Block, RuntimeApi};
...
impl sc_executor::NativeExecutionDispatch for ExecutorDispatch {
    ...
    fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
        eth_pbc_runtime::api::dispatch(method, data)
    }

    fn native_version() -> sc_executor::NativeVersion {
        eth_pbc_runtime::native_version()
    }
}
