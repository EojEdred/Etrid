...
// ETH-PBC Runtime
use eth_pbc_runtime::{AccountId, GenesisConfig, WASM_BINARY};
...
/// Generate genesis configuration for ETH-PBC
fn testnet_genesis(wasm_binary: &'static [u8]) -> GenesisConfig {
    use eth_pbc_runtime::{BalancesConfig, SystemConfig};
