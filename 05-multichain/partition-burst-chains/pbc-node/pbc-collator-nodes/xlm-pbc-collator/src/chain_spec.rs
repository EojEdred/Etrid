...
use xlm_pbc_runtime::{AccountId, WASM_BINARY};
...
pub fn local_testnet_config() -> Result<ChainSpec, String> {
    ...
    .with_name("XLM-PBC Local Testnet")
    .with_id("xlm_pbc_local")
    .with_chain_type(ChainType::Local)
    .with_protocol_id("xlm-pbc")
...
pub fn production_config() -> Result<ChainSpec, String> {
    ...
    .with_name("XLM-PBC Mainnet")
    .with_id("xlm_pbc_mainnet")
