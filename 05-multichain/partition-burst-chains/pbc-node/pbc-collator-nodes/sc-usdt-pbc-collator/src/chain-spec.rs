...
// SC-USDT-PBC Runtime
use sc_usdt_pbc_runtime::{AccountId, GenesisConfig, WASM_BINARY};
...
fn testnet_genesis(wasm_binary: &'static [u8]) -> GenesisConfig {
    use sc_usdt_pbc_runtime::{BalancesConfig, SystemConfig};
