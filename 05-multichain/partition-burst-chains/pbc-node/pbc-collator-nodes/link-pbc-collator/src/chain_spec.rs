...
pub fn development_config() -> Result<ChainSpec, String> {
    ...
    .with_name("LINK-PBC Development")
    .with_id("link_pbc_dev")
...
pub fn local_testnet_config() -> Result<ChainSpec, String> {
    ...
    .with_name("LINK-PBC Local Testnet")
    .with_id("link_pbc_local")
    .with_chain_type(ChainType::Local)
    .with_protocol_id("link-pbc")
...
pub fn production_config() -> Result<ChainSpec, String> {
    ...
    .with_name("LINK-PBC Mainnet")
    .with_id("link_pbc_mainnet")
