...
//!
//! This service:
//! 1. Produces blocks for the LINK-PBC
...
// LINK-PBC Runtime
use link_pbc_runtime::{self, opaque::Block, RuntimeApi};
...
impl sc_executor::NativeExecutionDispatch for ExecutorDispatch {
    ...
    fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
        link_pbc_runtime::api::dispatch(method, data)
    }

    fn native_version() -> sc_executor::NativeVersion {
        link_pbc_runtime::native_version()
    }
}

// Type aliases for LINK-PBC
...
pub fn new_partial(
    ...
    ServiceError,
> {
    // NOTE: This is a template. Implement actual service setup for LINK-PBC runtime.
    panic!("new_partial not implemented - update for specific LINK-PBC runtime")
}
