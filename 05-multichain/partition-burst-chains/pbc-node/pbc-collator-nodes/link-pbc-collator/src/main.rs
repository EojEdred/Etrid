//! LINK-PBC Collator Node (Chainlink)
//!
//! This collator produces blocks for the Chainlink Partition Burst Chain (LINK-PBC)
//! and submits state roots to FlareChain for multichain state aggregation.
//!
//! Features:
//! - Chainlink token bridge
//! - Oracle price feed services
//! - VRF (Verifiable Random Function) support
//! - Lightning channels for fast payments
