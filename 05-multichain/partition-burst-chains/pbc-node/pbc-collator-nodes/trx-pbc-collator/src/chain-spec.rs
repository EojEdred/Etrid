...
// TRX-PBC Runtime
use trx_pbc_runtime::{AccountId, RuntimeGenesisConfig, WASM_BINARY};
...
pub fn development_config() -> Result<ChainSpec, String> {
    Ok(ChainSpec::from_genesis(
        ...
        move || {
            panic!("Genesis config not implemented - update for specific TRX-PBC runtime")
        },
        vec![],
        None,
        None,
