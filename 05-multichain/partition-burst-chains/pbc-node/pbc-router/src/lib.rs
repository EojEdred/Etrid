...
//! ## Overview
//!
//! The PBC Router pallet manages cross-chain communication between Primearc Core Chain and
...
pub mod pallet {
    ...
    pub struct CrossChainMessage {
        /// Source PBC ID
        pub from_pbc: PbcId,
        /// Destination PBC ID (255 = Primearc Core Chain)
        pub to_pbc: PbcId,
    ...
    impl<T: Config> Pallet<T> {
        ...
        /// 
        /// Called by PBC collator nodes to submit state roots to Primearc Core Chain.
        ...
        /// 
        /// Routes a message from one PBC to another (or to Primearc Core Chain).
        /// 
        /// # Arguments
        /// * `from_pbc` - Source PBC ID
        /// * `to_pbc` - Destination PBC ID (255 = Primearc Core Chain)
