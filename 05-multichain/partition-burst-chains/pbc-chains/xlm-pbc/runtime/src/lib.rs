//! XLM-PBC RUNTIME - Stellar Partition Burst Chain
//! Integrates: Stellar Bridge + Lightning Channels + ASF Consensus
...
// Re-export Stellar bridge pallet
...
parameter_types! {
    pub const XlmLocalDomain: u32 = 148; // XLM domain ID
...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic,
    {
        ...
        StellarBridge: pallet_stellar_bridge,
