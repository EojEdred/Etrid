//! Lightning Channels Shim for eth-pbc-runtime
//!
//! Version-isolated implementation using stable2506 dependencies.
//! This shim provides the same API as pallet-lightning-channels but compiled
//! against stable2506 Substrate/Frontier dependencies to avoid WASM lang item conflicts.
