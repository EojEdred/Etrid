...
//! Integrates: BNB Bridge + Lightning Channels + ASF Consensus
...
parameter_types! {
    pub const LocalDomain: u32 = 56; // BNB-PBC domain ID (BNB Chain ID)
