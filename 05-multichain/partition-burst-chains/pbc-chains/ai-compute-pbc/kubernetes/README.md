...
2. **Etrid AI-Compute-PBC** running and accessible
   - RPC endpoint: `https://rpc.etrid.org/primearc/ai-compute-pbc:9944`
   - WebSocket endpoint: `wss://ws.etrid.org/primearc/ai-compute-pbc:9944`
...
```yaml
data:
  rpc_url: "https://rpc.etrid.org/primearc/ai-compute-pbc:9944"  # Your AI-Compute-PBC RPC
  websocket_url: "wss://ws.etrid.org/primearc/ai-compute-pbc:9944"
```
...
```bash
# Check RPC endpoint
curl -H "Content-Type: application/json" -d '{"id":1, "jsonrpc":"2.0", "method": "system_health"}' https://rpc.etrid.org/primearc/ai-compute-pbc:9944
...
- Documentation: https://docs.etrid.org/ai-compute-pbc
