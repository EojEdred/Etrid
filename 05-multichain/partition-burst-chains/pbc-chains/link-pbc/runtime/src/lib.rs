...
//! Integrates: Chainlink Bridge + Lightning Channels + ASF Consensus
...
// Re-export Chainlink bridge pallet
pub use pallet_chainlink_bridge;
...
pub const UNITS: Balance = 1_000_000_000_000; // 1 ETR = 10^12 units
...
impl pallet_chainlink_bridge::Config for Runtime {
    type RuntimeEvent = RuntimeEvent;
    type Currency = Balances;
...
parameter_types! {
    pub const LinkLocalDomain: u32 = 108; // LINK domain ID
...
impl pallet_token_messenger::Config for Runtime {
    ...
    type LocalDomain = LinkLocalDomain;
...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic,
    {
        ...
        ChainlinkBridge: pallet_chainlink_bridge,
