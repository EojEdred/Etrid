...
use etrid_primitives::{
    ...
    types::VMwMetrics,
    block::{Header as EtridHeader, Block as EtridBlock, Ants},
};

// Import consensus
pub use pallet_asf_consensus;
...
pub type Header = EtridHeader;

/// Block type as expected by this runtime.
pub type Block = EtridBlock;
...
const NORMAL_DISPATCH_RATIO: sp_arithmetic::Perbill = sp_arithmetic::Perbill::from_percent(75);
...
impl pallet_asf_consensus::Config for Runtime {
    type RuntimeEvent = RuntimeEvent;
...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic,
    {
        ...
        // Ëtrid Core
        ASFConsensus: pallet_asf_consensus,
