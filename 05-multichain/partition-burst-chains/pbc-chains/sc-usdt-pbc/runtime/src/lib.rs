//! SC-USDT-PBC RUNTIME - Stablecoin USDT Partition Burst Chain
//! Integrates: Stablecoin USDT Bridge + Lightning Channels + ASF Consensus
...
// Re-export Stablecoin USDT bridge pallet
pub use pallet_stablecoin_usdt_bridge;
...
// StablecoinUsdtBridge Configuration
parameter_types! {
...
parameter_types! {
    pub const UsdtLocalDomain: u32 = 105; // USDT domain ID
...
impl pallet_token_messenger::Config for Runtime {
    ...
    type LocalDomain = UsdtLocalDomain;
...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic,
    {
        ...
        StablecoinUsdtBridge: pallet_stablecoin_usdt_bridge,
