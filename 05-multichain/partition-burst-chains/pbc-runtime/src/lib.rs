...
// ═══════════════════════════════════════════════════════════════════════════════
// LIGHTNING-BLOC CHANNELS PALLET CONFIG
// State channels for off-chain payments with on-chain settlement
// ═══════════════════════════════════════════════════════════════════════════════
impl pallet_channels::Config for Runtime {
    type RuntimeEvent = RuntimeEvent;
    type Balance = Balance;
    type WeightInfo = ();
}
...
// ═══════════════════════════════════════════════════════════════════════════════
// CROSS-CHAIN BRIDGE PALLET CONFIG
// Messaging between PBCs and Primearc Core (Primearc Core Chain)
// ═══════════════════════════════════════════════════════════════════════════════
parameter_types! {
    /// This PBC's chain ID (1 = generic PBC, specific chains use 2-13)
    pub const PbcChainId: u8 = 1;
}

impl pallet_bridge::Config for Runtime {
    type RuntimeEvent = RuntimeEvent;
    type ChainId = PbcChainId;
    type WeightInfo = ();
}
...
construct_runtime!(
    pub struct Runtime {
        ...
        // ═════════════════════════════════════════════════════════════════════════
        // LIGHTNING-BLOC & CROSS-CHAIN PALLETS
        // ═════════════════════════════════════════════════════════════════════════
        /// State channels for off-chain payments (Lightning-Bloc Layer 2)
        Channels: pallet_channels,
        /// Cross-chain messaging bridge to Primearc Core and other PBCs
