...
#[frame_support::pallet]
	...
	impl<T: Config> Pallet<T> {
		...
		///
		/// Locks ETR on Primearc Core Chain and emits event for relayer to mint on BNB Chain
		...
		///
		/// Unlocks ETR on Primearc Core Chain when wrapped ETR is burned on BNB Chain
