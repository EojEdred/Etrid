...
pub mod pallet {
    ...
    impl<T: Config> Pallet<T> {
        ...
        ///
        /// Locks ETR on Primearc Core Chain and emits event for relayer to mint on Bitcoin
        #[pallet::call_index(7)]
        ...
        ///
        /// Unlocks ETR on Primearc Core Chain when wrapped ETR is burned on Bitcoin
        #[pallet::call_index(8)]
        #[pallet::weight(150_000)]
