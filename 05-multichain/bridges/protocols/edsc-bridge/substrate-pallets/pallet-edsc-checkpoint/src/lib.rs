...
//!
//! Posts state commitments from PBC-EDSC to Primearc Core Chain for cross-chain synchronization.
//!
//! ## Overview
//!
//! This pallet creates periodic checkpoints of the PBC-EDSC state that can be verified
//! on Primearc Core Chain. Each checkpoint includes:
...
pub mod pallet {
	...
	impl<T: Config> Pallet<T> {
		...
		/// Verify a checkpoint (called by Primearc Core Chain validators)
		#[pallet::weight(10_000)]
		#[pallet::call_index(3)]
