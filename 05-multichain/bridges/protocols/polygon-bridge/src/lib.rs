...
//! ## Overview
//! 
//! The Polygon Bridge pallet enables cross-chain communication between the Ëtrid Primearc Core Chain
...
pub mod pallet {
    ...
    impl<T: Config> Pallet<T> {
        ...
        ///
        /// Locks ETR on Primearc Core Chain and emits event for relayer to mint on Polygon
        #[pallet::call_index(9)]
        ...
        ///
        /// Unlocks ETR on Primearc Core Chain when wrapped ETR is burned on Polygon
