 ...
 * @notice Factory contract for creating PrimeSwap trading pairs
 * @dev Creates and manages all PrimeSwap pair contracts
 */
contract PrimeSwapFactory is IPrimeSwapFactory {
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        IPrimeSwapPair(pair).initialize(token0, token1);
