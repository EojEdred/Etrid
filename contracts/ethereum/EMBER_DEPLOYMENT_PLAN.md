...
3. **Verify Ember Node**
   ...
   wscat -c wss://ws.etrid.org/primearc/ember
   ```
...
1. **Deploy 3+ Attestation Services** (for 3-of-5 threshold)
   ...
   Service 1:
   ```env
   SUBSTRATE_WS_URL=wss://ws.etrid.org/primearc/ember
...
1. **Configure Relayer**
   ```env
   ATTESTATION_SERVICE_URLS=https://att1.etrid.org,https://att2.etrid.org,https://att3.etrid.org
   SUBSTRATE_WS_URL=wss://ws.etrid.org/primearc/ember
   ETHEREUM_RPC_URL=https://sepolia.infura.io/v3/YOUR_KEY
...
### Metrics Endpoints
- Attestation Service: `https://att1.etrid.org/metrics`
- Relayer Service: `https://relayer.etrid.org/metrics`

### Health Checks
- Attestation: `https://att1.etrid.org/health`
- Relayer: `https://relayer.etrid.org/health`
