...
├──────────────────────────────────────────────────────────┤
│                                                          │
│  21 Validators (FlareNodes)                              │
│  • Produce blocks via PPFA                               │
│  • Sign ASF checkpoint certificates                      │
│  • Finalize chain                                        │
│  • peer_type can be: FlareNode OR DecentralizedDirector  │
│                                                          │
└──────────────────────────────────────────────────────────┘
                         ↑
                         │ INDEPENDENT LAYERS
...
Validators: [
    { validator_id: 0, peer_type: 3 (FlareNode), stake: 200_ETR },  // Eoj
    { validator_id: 1, peer_type: 3 (FlareNode), stake: 150_ETR },  // Gizzi
    { validator_id: 2, peer_type: 3 (FlareNode), stake: 150_ETR },  // Val3
    // ... 21 total validators
]
...
```json
{
  "validatorCommittee": {
    "validators": [
      ...
      { "validator_id": 0, "stake": 200_ETR, "peer_type": 3 },  // Eoj (FlareNode)
