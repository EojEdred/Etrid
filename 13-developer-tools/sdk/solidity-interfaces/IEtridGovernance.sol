 ...
 *
 * Enables ETH PBC contracts to participate in Primearc Core Chain governance.
 * Proposals and votes are executed via XCM messages to Primearc Core Chain.
 *
...
interface IEtridGovernance {
    ...
    /**
     * @notice Submit a new governance proposal to Primearc Core Chain
     ...
     *   );
     *
     * @dev Emits ProposalSubmitted event on Primearc Core Chain
     */
