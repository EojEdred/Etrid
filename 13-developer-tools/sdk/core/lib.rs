...
//! - **13 Independent Chains**: 1 Primearc Core Chain (root) + 12 Partition Burst Chains (PBC)
...
//! - **`multichain`** - Primearc Core Chain + PBC runtimes
...
#![warn(missing_docs)]
#![doc(
    html_logo_url = "https://etrid.org/logo.png",
    html_favicon_url = "https://etrid.org/favicon.ico"
)]
...
// ═══════════════════════════════════════════════════════════════════════════════
// MULTICHAIN - Primearc Core Chain + PBCs (feature: multichain)
// ═══════════════════════════════════════════════════════════════════════════════

#[cfg(feature = "multichain")]
/// Multichain infrastructure
///
/// Primearc Core Chain (root chain) and 12 Partition Burst Chains (PBCs) for different ecosystems.
///
/// # Examples
///
/// ```rust,ignore
...
///
/// // Access Primearc Core Chain runtime
