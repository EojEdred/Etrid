 ...
 *
 * Provides high-level TypeScript interface to interact with Primearc Core Chain features
...
export class ETHPBCPrecompiles {
  ...
  /**
   * Get price from Primearc Core Chain oracle
   *
  ...
  /**
   * Get price in ETH from Primearc Core Chain oracle
   *
  ...
  /**
   * Create a governance proposal on Primearc Core Chain
   *
