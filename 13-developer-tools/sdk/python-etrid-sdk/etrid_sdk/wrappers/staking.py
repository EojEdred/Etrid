...
Nominate validators and earn staking rewards on Primearc Core Chain.
"""
...
class StakingWrapper:
    """
    Wrapper for Staking pallet - Primearc Core Chain validator nomination.
    ...
    async def estimate_rewards(self, address: str, amount: int) -> Dict[str, int]:
        ...
        try:
            # Base APY of ~10% for Primearc Core Chain
            base_apy = 0.10
