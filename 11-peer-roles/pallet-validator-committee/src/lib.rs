...
pub mod pallet {
    ...
    pub struct StoredValidatorInfo {
        ...
        pub stake: Balance,
        // Store peer_type as u8: 0=ValidityNode, 1=DecentralizedDirector, 2=StakingCommon, 3=Common
        pub peer_type: u8,
    }
    ...
    impl StoredValidatorInfo {
        ...
        /// Maps u8 to PeerType: 0=ValidityNode, 1=DecentralizedDirector, 2=StakingCommon, 3=Common
        pub fn to_validator_info(&self) -> ValidatorInfo {
            let peer_type = match self.peer_type {
                0 => PeerType::ValidityNode,           // Genesis validators use 0
                1 => PeerType::DecentralizedDirector,  // Directors use 1
                2 => PeerType::StakingCommon,          // Staking peers use 2
                3 => PeerType::Common,                 // Common peers use 3
                _ => PeerType::ValidityNode,           // Default to ValidityNode for validators
            };
