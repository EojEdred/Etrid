...
struct APIConfig {
    ...
    #if DEBUG
    let gpuBaseURL = "https://dev-api.etrid.org/v1/gpu"
    let hyperledgerBaseURL = "https://dev-api.etrid.org/v1/hyperledger"
    let ethpbcBaseURL = "https://dev-api.etrid.org/v1/ethpbc"
    let ethpbcRPCURL = "https://dev-rpc.ethpbc.etrid.org"
    #else
    let gpuBaseURL = "https://api.etrid.org/v1/gpu"
    let hyperledgerBaseURL = "https://api.etrid.org/v1/hyperledger"
    let ethpbcBaseURL = "https://api.etrid.org/v1/ethpbc"
    let ethpbcRPCURL = "https://rpc.ethpbc.etrid.org"
    #endif
}
```
