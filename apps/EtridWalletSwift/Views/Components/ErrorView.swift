...
struct ErrorView: View {
    ...
    private func openSupport() {
        Haptics.selection()
        if let url = URL(string: "https://support.etrid.io") {
    ...
    private func reportBug() {
        ...
        if let url = URL(string: "mailto:support@etrid.io?subject=\(subject.addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed) ?? "")&body=\(body.addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed) ?? "")") {
            UIApplication.shared.open(url)
        }
