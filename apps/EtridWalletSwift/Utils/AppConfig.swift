...
class AppConfig: ObservableObject {
    ...
    enum Environment: String, CaseIterable {
        ...
        var baseURL: String {
            switch self {
            case .development:
                return "https://dev-api.etrid.io"
            case .staging:
                return "https://staging-api.etrid.io"
            case .production:
                return "https://api.etrid.io"
            }
        }
        ...
        var rpcEndpoint: String {
            switch self {
            case .development:
                return "https://dev-rpc.etrid.io"
            case .staging:
                return "https://staging-rpc.etrid.io"
            case .production:
                return "https://rpc.etrid.io"
            }
        }
        ...
        var explorerURL: String {
            switch self {
            case .development:
                return "https://dev-explorer.etrid.io"
            case .staging:
                return "https://staging-explorer.etrid.io"
            case .production:
                return "https://explorer.etrid.io"
            }
        }
