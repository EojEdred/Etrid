...
///
/// Defines endpoints and parameters for Primearc Core Chain and all 13 PBCs
...
enum ChainType {
  relay,  // Primearc Core Chain
  pbc,    // Partition Burst Chain
}

class EtridChainRegistry {
  // Primearc Core Chain (Main settlement layer)
  static const primearcCoreChain = ChainConfig(
  ...
  /// Get relay chain (Primearc Core Chain)
  static ChainConfig get relayChain => primearcCoreChain;
}
