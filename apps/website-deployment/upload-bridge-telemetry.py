#!/usr/bin/env python3
"""
Upload Bridge and Telemetry fixes to Hostinger
"""
...
FILES_TO_UPLOAD = [
    ("apps/bridge/index.html", "domains/etrid.org/public_html/bridge/index.html"),
...
def main():
    print("=" * 60)
    print("ËTRID Bridge & Telemetry Upload")
    print("=" * 60)
    print()
    ...
    try:
        ...
        if fail_count == 0:
            ...
            print()
            print("Live URLs:")
            print("  • Bridge: https://bridge.etrid.org")
            print("  • Telemetry: https://telemetry.etrid.org")
            print()
            print("What's Fixed:")
            print("  ✅ Bridge now has working wallet connection")
            print("  ✅ Bridge fetches real ÉTR balance from FlareChain")
            print("  ✅ Telemetry loads correct JavaScript file")
            print("  ✅ Telemetry connects to ws://98.71.91.84:30334")
        else:
