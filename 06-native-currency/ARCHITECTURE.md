...
**Status:** Canonical source for VMW economics
...
**Architecture Note:**
This module is the **canonical source of truth** for VMW economics. The ETWasm VM module (`08-etwasm-vm/gas-metering/`) re-exports from this module rather than duplicating the implementation.

```
06-native-currency/vmw-gas/     ← Canonical source (this module)
         ↑
...
VMW is fundamentally an economic concept (computation pricing, fees, conversion to ÉTR), so it belongs in the Native Currency module rather than the VM module.
