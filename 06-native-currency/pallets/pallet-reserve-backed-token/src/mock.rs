//! Mock runtime for testing pallet-reserve-backed-token

use crate as pallet_reserve_backed_token;
use frame_support::{
	parameter_types,
...
parameter_types! {
	...
	pub const RebalanceInterval: u64 = 100;
