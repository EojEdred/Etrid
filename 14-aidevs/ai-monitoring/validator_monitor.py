...
class ValidatorMonitor:
    ...
    def _check_process_ssh(self, validator: Dict) -> Dict:
        ...
        try:
            ...
            # Check if primearc-core-chain-node is running
            stdin, stdout, stderr = ssh.exec_command(
                "pgrep -f primearc-core-chain-node || echo 'not_running'"
            )
    ...
    def restart_validator(self, validator_num: int, reason: str):
        ...
        try:
            ...
            stdin, stdout, stderr = ssh.exec_command(
                "sudo systemctl restart primearc-core-chain-validator || "
                "(pkill -9 primearc-core-chain-node && nohup ~/primearc-core-chain-node --validator > /dev/null 2>&1 &)"
            )
