...
class GovernanceAI:
    ...
    async def connect_to_chain(self):
        ...
        try:
            ...
            logger.info(f"✅ Connected to Primearc Core Chain: {self.blockchain_rpc}")
    ...
    def _create_proposal_prompt(self, proposal_type: str, context: Dict[str, Any]) -> str:
        ...
        if proposal_type == 'treasury':
            return f"""You are a governance expert for Primearc Core Chain blockchain. Generate a treasury spending proposal.
...
"""
            ...
            return f"""You are a governance expert for Primearc Core Chain. Generate a proposal to address validator set issues.
...
"""
            ...
            return f"""Generate a runtime upgrade proposal for Primearc Core Chain.
...
"""
            ...
            return f"""Generate a governance proposal for Primearc Core Chain.
...
"""
    ...
    async def simulate_voting(self, proposal: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            prompt = f"""You are analyzing a Primearc Core Chain governance proposal voting simulation.
