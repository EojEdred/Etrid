...
//!
//! This service:
//! 1. Produces blocks for the ADA-PBC
...
// ADA-PBC Runtime
use ada_pbc_runtime::{self, opaque::Block, RuntimeApi};
...
impl sc_executor::NativeExecutionDispatch for ExecutorDispatch {
    ...
    fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
        ada_pbc_runtime::api::dispatch(method, data)
    }

    fn native_version() -> sc_executor::NativeVersion {
        ada_pbc_runtime::native_version()
    }
}
...
pub fn new_partial(
    ...
    ServiceError,
> {
    // NOTE: This is a template. Implement actual service setup for ADA-PBC runtime.
    panic!("new_partial not implemented - update for ADA-PBC runtime")
}
...
pub async fn start_collator(config: Configuration) -> Result<TaskManager, ServiceError> {
    ...
    panic!("start_collator not implemented - update for ADA-PBC runtime")
