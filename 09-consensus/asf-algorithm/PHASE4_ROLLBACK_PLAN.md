...
RUNTIME_DIR="/Users/macbook/Desktop/etrid/05-multichain/primearc-core-chain/runtime"
NODE_DIR="/Users/macbook/Desktop/etrid/05-multichain/primearc-core-chain/node"
...
```bash
cd /Users/macbook/Desktop/etrid/05-multichain/primearc-core-chain/runtime/src
...
```bash
cd /Users/macbook/Desktop/etrid/05-multichain/primearc-core-chain/node
...
```bash
cd /Users/macbook/Desktop/etrid/05-multichain/primearc-core-chain/node
./target/release/primearc-core-chain-node build-spec --chain primearc-core-chain_mainnet_asf > chainspec-v106.json
```
...
```bash
grep "spec_version:" /Users/macbook/Desktop/etrid/05-multichain/primearc-core-chain/runtime/src/lib.rs | head -1
# Expected: spec_version: 106
```
...
```bash
# Runtime Cargo.toml
grep -c "grandpa" /Users/macbook/Desktop/etrid/05-multichain/primearc-core-chain/runtime/Cargo.toml
# Expected: 2 (pallet-grandpa, sp-consensus-grandpa)

# Node Cargo.toml
grep -c "grandpa" /Users/macbook/Desktop/etrid/05-multichain/primearc-core-chain/node/Cargo.toml
...
```bash
grep -A 3 "impl_opaque_keys!" /Users/macbook/Desktop/etrid/05-multichain/primearc-core-chain/runtime/src/lib.rs
# Expected to show:
...
```bash
grep -A 10 "impl sp_consensus_grandpa::GrandpaApi" /Users/macbook/Desktop/etrid/05-multichain/primearc-core-chain/runtime/src/lib.rs
...
2. **Restore v106 Binary**
   ...
   scp target/release/primearc-core-chain-node user@validator:/usr/local/bin/
   ```

3. **Restore v106 Chainspec**
   ```bash
   # On each validator
   sudo cp /var/lib/primearc-core-chain/chainspec-v106-backup.json /var/lib/primearc-core-chain/chainspec.json
   ```

4. **Clear Database (If Incompatible)**
   ```bash
   # WARNING: This loses all v108 chain state
   sudo rm -rf /var/lib/primearc-core-chain/chains/etrid_mainnet/db
   ```
...
6. **Monitor Consensus**
   ...
   journalctl -u primearc-core-chain-validator -f | grep -i "grandpa\|finalized"
   ```
